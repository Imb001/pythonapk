...
from kivymd.uix.behaviors import CommonElevationBehavior #CommonElevationBehavior
...
class SearchBar(CommonElevationBehavior, MDFloatLayout):
     pass
...
class Ar_text(TextInput):
    ...
    def __init__(self, **kwargs):
        ...
        # self.text_hint = bidi.algorithm.get_display(arabic_reshaper.reshape("اطبع شيئاً"))
...
class Social(MDApp):
    ...
    def prompt_res(self, *args):
        ...
        screen_manager.get_screen(page).text_input.hint_text ="Type message.."
    ...
    def chat_send(self, page1):
        ...
        if screen != "" or screen != " ":
            ...
            if len(value) < 3:
                ...
                halign = "left" 
            if arabic == 'Yes':
                txt = self.arabic_(value)
                
                screen_manager.get_screen(page).chat_list.add_widget(Command2(text=txt, size_hint_x=size, halign=halign)) 
            else:     
    ...
    def response(self, *args):
        ...
        # if len(value) != 0:
            ...
            # if arabic == 'Yes':
            #     # print(arabic)
            #     txt = self.arabic_(response)
            #     screen_manager.get_screen(page).chat_list.add_widget(Response2(text=txt, size_hint_x=.72,  halign="left"))
            # else:
