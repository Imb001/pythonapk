...
requirements = python3,kivy,kivymd,requests,openai,python-bidi,arabic-reshaper,jnius, android, https://github.com/MichaelStott/KivMob/archive/refs/heads/master.zip
